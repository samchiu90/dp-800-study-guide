...
But what does the term **_vector_** mean in the context of AI integration with a SQL database?
...
For example, when the text _"lightweight hiking backpack"_ is sent to an embedding model, the model might return:

`[0.12, -0.87, 0.45, 0.31, …]`

A related sentence such as _"compact backpack for day hikes"_ would produce a different list of numbers that looks similar:
