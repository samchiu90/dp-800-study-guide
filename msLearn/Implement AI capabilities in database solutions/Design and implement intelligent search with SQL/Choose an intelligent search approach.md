...
Full-text search finds products containing the words _comfortable_, _bike_, and _seat_. Vector search finds semantically similar products, including saddles that don't use the word _seat_ at all.
