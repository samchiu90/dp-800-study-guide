...
![Diagram showing Model Context Protocol architecture with GitHub Copilot to an MCP Server that accesses a SQL Database.](https://learn.microsoft.com/en-us/training/wwl-data-ai/design-implement-sql-solutions-ai-assisted-tools/media/data-flow.png)
...
GitHub Copilot supports MCP integration through agent mode in VS Code. To [use MCP servers in VS Code](https://learn.microsoft.com/en-us/azure/data-api-builder/mcp/quickstart-visual-studio-code):
...
- **Microsoft Fabric MCP Server**: Connects to [Fabric data agents as MCP servers](https://learn.microsoft.com/en-us/fabric/data-science/data-agent-mcp-server), enabling AI assistants to query lakehouses, warehouses, and SQL databases within Fabric workspaces.
...
1. VS Code detects the configuration and prompts you to start the server
