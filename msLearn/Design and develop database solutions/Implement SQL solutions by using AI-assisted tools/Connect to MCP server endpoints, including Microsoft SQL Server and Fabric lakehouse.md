...
For SQL Server and Azure SQL databases, you can use the [SQL MCP Server](https://learn.microsoft.com/en-us/sql/mcp/) or configure direct connections through supported tools.

**Using SQL MCP Server:**

SQL MCP Server is Microsoft's open-source solution built on Data API builder that enables AI agents to interact with SQL databases. To set up [SQL MCP servers in VS Code](https://learn.microsoft.com/en-us/azure/data-api-builder/mcp/quickstart-visual-studio-code):
