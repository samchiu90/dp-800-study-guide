...
> [!Important]
>
> Always check `@@TRANCOUNT` before calling `ROLLBACK TRANSACTION` in a `CATCH` block. This prevents the error _"ROLLBACK TRANSACTION request has no corresponding BEGIN TRANSACTION."_
...
For more information about error handling, see [TRY...CATCH (Transact-SQL)](https://learn.microsoft.com/en-us/sql/t-sql/language-elements/try-catch-transact-sql) and [THROW (Transact-SQL)](https://learn.microsoft.com/en-us/sql/t-sql/language-elements/throw-transact-sql).
