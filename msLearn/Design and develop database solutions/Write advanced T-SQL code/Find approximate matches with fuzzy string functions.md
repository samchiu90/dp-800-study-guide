...
For more information about fuzzy string matching, see [String Functions](https://learn.microsoft.com/en-us/sql/t-sql/functions/string-functions-transact-sql).
