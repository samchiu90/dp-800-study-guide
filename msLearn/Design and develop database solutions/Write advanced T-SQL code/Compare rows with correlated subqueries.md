...
For more information about subqueries, see [Subqueries (Transact-SQL)](https://learn.microsoft.com/en-us/sql/relational-databases/performance/subqueries) and [EXISTS (Transact-SQL)](https://learn.microsoft.com/en-us/sql/t-sql/language-elements/exists-transact-sql).