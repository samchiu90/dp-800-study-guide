...
SQL Server programmability objects provide different ways to encapsulate and reuse logic in your database. Each object type—[views](https://learn.microsoft.com/en-us/sql/relational-databases/views/views), [stored procedures](https://learn.microsoft.com/en-us/sql/relational-databases/stored-procedures/stored-procedures-database-engine), [functions](https://learn.microsoft.com/en-us/sql/relational-databases/user-defined-functions/user-defined-functions), and [triggers](https://learn.microsoft.com/en-us/sql/relational-databases/triggers/dml-triggers)—serves distinct purposes and offers unique capabilities.
