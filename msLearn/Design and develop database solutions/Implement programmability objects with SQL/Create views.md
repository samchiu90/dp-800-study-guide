...
[Views](https://learn.microsoft.com/en-us/sql/relational-databases/views/views) simplify how you access and present data in SQL Server. As a SQL developer, you create views to encapsulate complex queries, provide security boundaries, and present data in a format that matches your application's needs.
...
![Diagram showing how a view retrieves data from underlying tables.](https://learn.microsoft.com/en-us/training/wwl-data-ai/implement-programmability-objects/media/views.png)
...
You create a view using the [`CREATE VIEW`](https://learn.microsoft.com/en-us/sql/t-sql/statements/create-view-transact-sql) statement followed by a `SELECT` query. The view definition determines what data appears when you query the view.
