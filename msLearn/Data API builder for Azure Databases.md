---
layout: Conceptual
title: What is Data API builder? - Azure Databases | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/azure/data-api-builder/overview
breadcrumb_path: /azure/data-api-builder/breadcrumb/toc.json
feedback_system: Standard
feedback_product_url: https://github.com/azure/data-api-builder/issues/new/choose
feedback_help_link_url: https://github.com/azure/data-api-builder/discussions
...
locale: en-us
document_id: 4f029310-9446-41f8-eb20-fd10ea3785b6
document_version_independent_id: 4f029310-9446-41f8-eb20-fd10ea3785b6
updated_at: 2026-05-05T17:11:00.0000000Z
original_content_git_url: https://github.com/MicrosoftDocs/data-api-builder-docs-pr/blob/live/data-api-builder/overview.md
gitcommit: https://github.com/MicrosoftDocs/data-api-builder-docs-pr/blob/95fe46249914f594abfbc262ce5b0d0a98977045/data-api-builder/overview.md
git_commit_id: 95fe46249914f594abfbc262ce5b0d0a98977045
site_name: Docs
depot_name: MSDN.data-api-builder-docs
...
monikers: []
item_type: Content
source_path: data-api-builder/overview.md
cmProducts:
...
platformId: 8eb28499-67cf-ee3d-11c5-c479ca4d87fc
---
...
![Illustration of the Data API builder mascot wearing a construction hat.](media/overview/mascot.png)
...
Data API builder supports both REST and GraphQL endpoints out of the box and simultaneously. With version 1.7 and later, DAB also supports [Model Context Protocol (MCP) for agent apps](mcp/overview) with the same rich functionality.
...
Data API builder (DAB) supports multiple backend data sources simultaneously, including relational and NoSQL sources. Supported databases include SQL Server and Azure SQL, Azure Cosmos DB, PostgreSQL, and MySQL. For details and limitations by database, see [Feature availability](feature-availability).
...
| Provider | Use case |
| --- | --- |
| [**Unauthenticated**](concept/security/authenticate-unauthenticated) | DAB sits behind a trusted front end that handles identity (default) |
...
For step-by-step configuration guides, see [Security overview](concept/security/).
...
DAB works great with Azure App Service, Azure Container Apps, Azure Container Instances, Azure Kubernetes Service, and Azure Web Apps for Containers. DAB works with these services while fully supporting custom, on-premises deployments. For a full comparison, see [deployment options](deployment/).
