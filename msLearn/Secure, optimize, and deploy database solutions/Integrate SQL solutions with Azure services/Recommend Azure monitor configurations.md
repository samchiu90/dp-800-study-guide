...
Running Data API Builder in production requires monitoring to understand performance, diagnose issues, and optimize resource usage. [Azure Monitor](https://learn.microsoft.com/en-us/azure/azure-monitor/overview) provides the comprehensive observability platform that integrates with DAB through Application Insights and Log Analytics.
...
[Application Insights](https://learn.microsoft.com/en-us/azure/azure-monitor/app/app-insights-overview) captures detailed information from your Data API Builder instance, including request traces, dependency calls to your database, and exception details.
...
[Log Analytics](https://learn.microsoft.com/en-us/azure/azure-monitor/logs/log-analytics-overview) provides a central repository for logs from all Azure resources. Configure your DAB deployment to send logs to a Log Analytics workspace.
