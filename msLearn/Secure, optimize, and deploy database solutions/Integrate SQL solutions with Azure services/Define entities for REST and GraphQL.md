...
[Data API Builder caching](https://learn.microsoft.com/en-us/azure/data-api-builder/concept/cache/level-1) reduces database load by storing query results temporarily. You can configure caching at both the global level (in the runtime section) and per-entity for fine-grained control.
