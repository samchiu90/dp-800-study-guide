...
<button class="button button-clear button-sm display-flex gap-xxs"><span></span></button>

| session\_id | blocking\_session\_id |
| --- | --- |
| 55 | 52 |
| 60 | 52 |
| 52 | 0 |
...
![Diagram showing two sessions in a deadlock. Each session owns a resource that the other session needs in order to continue.](https://learn.microsoft.com/en-us/training/wwl-data-ai/optimize-database-performance/media/deadlock-overview.png)
