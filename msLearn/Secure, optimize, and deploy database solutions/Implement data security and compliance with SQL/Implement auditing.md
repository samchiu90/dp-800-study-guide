...
![Diagram showing Azure SQL Database sending audit logs Azure Blob Storage, Log Analytics workspace and Event Hubs.](https://learn.microsoft.com/en-us/training/wwl-data-ai/implement-data-security-compliance/media/auditing.png)

[SQL Server Audit](https://learn.microsoft.com/en-us/sql/relational-databases/security/auditing/sql-server-audit-database-engine) uses the Extended Events infrastructure to record activity. You can write audit records to files, the Windows Security log, or the Windows Application log. This flexibility lets you integrate with existing log management systems.

[Azure SQL Database auditing](https://learn.microsoft.com/en-us/azure/azure-sql/database/auditing-overview) writes to Azure Blob Storage, Log Analytics, or Event Hubs. The managed service handles the infrastructure, so you can focus on deciding what to audit rather than managing storage.
