...
![Diagram that shows the three API endpoint types connecting to Azure SQL Database with authentication and authorization layers: GraphQL, REST, and MCP.](https://learn.microsoft.com/en-us/training/wwl-data-ai/implement-data-security-compliance/media/mcp.png)

## Secure GraphQL endpoints

Azure SQL Database and SQL databases in Microsoft Fabric support GraphQL through [Data API builder](https://learn.microsoft.com/en-us/azure/data-api-builder/overview) and Microsoft Fabric's GraphQL API. Securing these endpoints involves authentication, authorization, and query controls.
...
Use [Private Link](https://learn.microsoft.com/en-us/azure/azure-sql/database/private-endpoint-overview) or service endpoints to keep traffic on the Microsoft network:
