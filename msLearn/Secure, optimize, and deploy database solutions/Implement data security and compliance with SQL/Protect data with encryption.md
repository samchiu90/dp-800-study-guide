...
Database encryption operates at different layers, each solving a specific problem. [Transparent Data Encryption (TDE)](https://learn.microsoft.com/en-us/sql/relational-databases/security/encryption/transparent-data-encryption) encrypts data at rest—think of it as protecting your database files on disk. [Column-level encryption](https://learn.microsoft.com/en-us/sql/relational-databases/security/encryption/encrypt-a-column-of-data) targets specific sensitive columns, while [Always Encrypted](https://learn.microsoft.com/en-us/sql/relational-databases/security/encryption/always-encrypted-database-engine) goes further by protecting data throughout its lifecycle, even during query processing.

![Diagram that shows the three encryption layers: TDE, column-level encryption, and Always Encrypted.](https://learn.microsoft.com/en-us/training/wwl-data-ai/implement-data-security-compliance/media/encryption.png)
...
![Diagram showing the Always Encrypted data flow, where client applications encrypt/decrypt data while the database engine only processes ciphertext.](https://learn.microsoft.com/en-us/training/wwl-data-ai/implement-data-security-compliance/media/sql-data-flow.png)

To get started with Always Encrypted, you first create a column master key (CMK) that protects your column encryption keys. Store the CMK in a secure [key store](https://learn.microsoft.com/en-us/sql/relational-databases/security/encryption/create-and-store-column-master-keys-always-encrypted) such as Azure Key Vault, Windows Certificate Store, or a hardware security module.
